...
(function() {
  ...
  const middleRow = [40,41,42,43,44,45,62,68,73,54,76,65,70,74,72,56,59,127,128,129,122,121,123,124];

  // Alarivi (row-3)
  const bottomRow = [100,101,120,111,113,118,103,123,121,127,128,125,83,81,82,86,89,94,114,105,107,106,91,90,93,118,116,117,119,112,110];
